...
# 5. Залить ветку в ремоут
git push origin fix/название-правки

# 6. Протестировать на тестовой странице
